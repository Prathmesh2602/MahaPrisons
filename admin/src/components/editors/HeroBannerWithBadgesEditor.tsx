...
interface HeroBannerWithBadgesEditorProps {
  data: any;
...
export const HeroBannerWithBadgesEditor: React.FC<HeroBannerWithBadgesEditorProps> = ({ data, updateData, blockId, expandedSection }) => {
