...
interface CardsAndVerticalTimelineEditorProps {
  data: any;
...
export const CardsAndVerticalTimelineEditor: React.FC<CardsAndVerticalTimelineEditorProps> = ({ data, updateData, blockId, expandedSection }) => {
