...
interface HeroBannerWithArticlesEditorProps {
  data: any;
...
export const HeroBannerWithArticlesEditor: React.FC<HeroBannerWithArticlesEditorProps> = ({ data, updateData, blockId, expandedSection }) => {
