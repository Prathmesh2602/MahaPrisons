    ...
    <div id="accessibility-toolbar" className={`w-full bg-white/70 backdrop-blur-md py-0.5 px-4 md:px-8 text-xs font-semibold text-gray-700 flex flex-wrap justify-between items-center z-50 sticky top-0 smooth-transition select-none devanagari-force ${isScrolled ? 'border-b border-gray-300/50 shadow-sm' : 'border-b border-transparent'}`}>
      ...
      <div className="flex items-center gap-4 relative">
        ...
        <button
          ...
          className={`p-1 rounded-md hover:bg-black/5 cursor-pointer transition-colors flex items-center gap-1.5 ${searchOpen ? 'text-[#0F3D66] bg-black/5' : 'text-gray-700 hover:text-gray-900'}`}
          title={t("Search")}
        >
        ...
        <a
          ...
          className="p-1 rounded-md hover:bg-black/5 text-gray-700 hover:text-gray-900 transition-colors flex items-center gap-1.5"
          title={t("Sitemap")}
        >
        ...
        <div ref={dropdownRef} className="relative flex items-center">
          ...
          <button
            ...
            className={`p-1 rounded-md hover:bg-black/5 cursor-pointer transition-colors flex items-center gap-1.5 ${panelOpen ? 'text-[#0F3D66] bg-black/5' : 'text-gray-700 hover:text-gray-900'}`}
