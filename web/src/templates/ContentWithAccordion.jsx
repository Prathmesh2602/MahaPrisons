          ...
          {data.keyFunctions.map((func, idx) => {
            ...
            return (
              <fmotion.div 
                ...
                className={`bg-white dark-mode:bg-[#2A2621] rounded-2xl overflow-hidden shadow-lg border-2 cursor-pointer transition-colors duration-300 ${isActive ? 'border-[#D4A373]' : 'border-[#F2E8D5] dark-mode:border-[#3D372E] hover:border-[#D4A373]/50'}`}
              ...
              >
                <div className="p-6 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-lg font-bold text-[#4A3219] dark-mode:text-[#E8DCC8]">{getTranslation(func.title)}</h3>
                  </div>
