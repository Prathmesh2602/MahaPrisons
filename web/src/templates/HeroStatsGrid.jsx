...
const HeroStatsGrid = ({ dataId, data: dynamicData }) => {
  ...
  return (
    <div className="w-full bg-[#fdfaf6] dark-mode:bg-slate-900 pb-20 font-poppins min-h-screen">
      ...
      <div data-block-type="template_general" className="pt-16 pb-24 px-6 relative overflow-hidden bg-gradient-to-br from-amber-50 to-orange-100 dark-mode:from-slate-800 dark-mode:to-slate-900 rounded-b-[3rem] border-b border-amber-200/50 dark-mode:border-slate-800 shadow-sm">
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center gap-12 relative z-10">
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              ...
              {data.labels?.category ? getTranslation(data.labels.category) : (language === 'mr' ? 'दैनंदिन सुविधा' : 'Daily Facilities')}
            </motion.div>
            <motion.h1 
      ...
      <div className="container mx-auto px-6 -mt-10 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8">
            <div data-block-type="template_features">
              <h3 className="text-2xl font-bold text-slate-800 dark-mode:text-white mb-8 ml-2">
                {data.labels?.features ? getTranslation(data.labels.features) : (language === 'mr' ? 'वैशिष्ट्ये आणि सुविधा' : 'Features & Facilities')}
              </h3>
            ...
            <div data-block-type="template_gallery">
              <h3 className="text-2xl font-bold text-slate-800 dark-mode:text-white mb-8 mt-16 ml-2">
                {data.labels?.gallery ? getTranslation(data.labels.gallery) : (language === 'mr' ? 'छायाचित्रे' : 'Gallery')}
              </h3>
            ...
            <div className="bg-white dark-mode:bg-slate-800 rounded-[2rem] p-8 shadow-xl border border-orange-100 dark-mode:border-slate-700 sticky top-32">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-2xl font-bold text-slate-800 dark-mode:text-white">
                  {data.labels?.timings ? getTranslation(data.labels.timings) : (language === 'mr' ? 'वेळापत्रक' : 'Timings')}
                </h3>
              </div>
