    ...
    <div className="min-h-screen bg-white dark-mode:bg-black text-gray-900 dark-mode:text-white font-poppins overflow-hidden">
      ...
      <div className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <motion.div style={{ y: y1 }} className="absolute inset-0 z-0 w-full h-[120%] -top-[10%]">
          <img src={data.hero?.heroImage} alt="Remission" className="w-full h-full object-cover opacity-80" />
      ...
      <div className="container mx-auto px-6 relative z-20 pb-24">
        ...
        <div className="text-center max-w-3xl mx-auto -mt-10 mb-10 bg-white dark-mode:bg-gray-900 p-6 md:p-6 rounded-2xl shadow-2xl border border-gray-100 dark-mode:border-gray-800">
        ...
        <div className="mt-32 border-t-2 border-gray-100 dark-mode:border-gray-800 pt-16 flex flex-col md:flex-row justify-center items-center gap-6 text-gray-500 dark-mode:text-gray-400 font-medium">
