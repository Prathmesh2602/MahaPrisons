      ...
      <div className="container mx-auto px-6 py-10 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.div 
            ...
            className="w-8 h-8 mx-auto bg-gradient-to-br from-cyan-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(6,182,212,0.4)] mb-8"
          >
            <Cpu className="w-6 h-6 text-white" />
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            className="text-2xl md:text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-500 mb-4 pb-4 pt-2 leading-snug"
          >
            {getTranslation(data.hero?.title)}
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            className="text-base text-blue-200/70"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center mb-10">
          <motion.div 
            ...
            className="relative rounded-2xl overflow-hidden p-1 bg-gradient-to-br from-cyan-500/30 to-blue-600/10 backdrop-blur-xl"
          >
            <div className="relative rounded-[22px] overflow-hidden">
              <img src={data.hero?.heroImage} alt="Smart Card" className="w-full h-auto aspect-video object-cover" />
          ...
          <motion.div 
            ...
            className="bg-white/5 border border-white/10 p-6 md:p-10 rounded-2xl backdrop-blur-md shadow-2xl"
          >
          ...
          {(data.keyFunctions || []).map((func, idx) => {
            ...
            return (
              <motion.div 
                ...
                className="group relative bg-white/[0.03] border border-white/[0.05] hover:border-cyan-500/30 rounded-2xl p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(6,182,212,0.1)]"
              >
                <div className="w-6 h-6 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <Icon className="w-7 h-7 text-cyan-400" />
                </div>
                <h3 className="text-lg font-bold text-white mb-4">{getTranslation(func.title)}</h3>
