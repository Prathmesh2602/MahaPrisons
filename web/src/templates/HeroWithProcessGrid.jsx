...
import { Settings, Zap, CheckCircle2, Factory, TrendingUp, ShieldCheck, Activity } from 'lucide-react';

const iconMap = {
  Settings, Zap, CheckCircle2, Factory, TrendingUp, ShieldCheck, Activity
};
      ...
      <div data-block-type="template_hero" className="relative bg-white dark-mode:bg-slate-900 border-b border-slate-200 dark-mode:border-slate-800">
        <div className="container mx-auto px-6 lg:px-12 py-16 lg:py-10 flex flex-col lg:flex-row items-center gap-6">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              {(() => {
                ...
                return CustomIcon ? <CustomIcon className="w-4 h-4" /> : <Factory className="w-4 h-4" />;
              })()}
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            >
              <img src={data.hero?.heroImage} alt="Minda Unit" className="w-full h-[400px] object-cover" />
              {/* Overlay Gradient */}
            ...
            >
              ...
              <div>
                ...
                <div className="text-base font-bold text-slate-800 dark-mode:text-slate-100">100% Practical</div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-lg font-bold text-slate-800 dark-mode:text-white mb-6 border-b border-slate-200 dark-mode:border-slate-800 pb-4 flex items-center gap-3">
              ...
              {data.sectionHeaders?.stats?.title ? getTranslation(data.sectionHeaders.stats.title) : (language === 'mr' ? 'तांत्रिक प्रशिक्षण क्षेत्रे' : 'Technical Training Areas')}
            </h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark-mode:text-slate-400 mt-2">
                        {data.sectionHeaders?.technicalFocus?.title ? getTranslation(data.sectionHeaders.technicalFocus.title) : (language === 'mr' ? 'उद्योग मानकांनुसार व्यावसायिक प्रशिक्षण.' : 'Professional training as per industry standards.')}
                      </p>
                    </div>
                  </div>
                </motion.div>
