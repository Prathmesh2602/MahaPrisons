  ...
  return (
    <div data-block-type="template" className="min-h-screen bg-[#FDFDFD] dark-mode:bg-gray-950 text-gray-800 dark-mode:text-gray-200">
      ...
      <div className="container mx-auto px-6 lg:px-12 pt-24 pb-12 flex flex-col items-center text-center">
        ...
        >
          <MapPin className="w-5 h-5" /> {getTranslation(data.hero?.subtitle)}
        </motion.p>
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 pb-24">
        <div className="relative w-full max-w-5xl mx-auto">
          ...
          >
            <img src={data.hero?.heroImage} alt="Mangal Lawn" className="w-full h-[400px] md:h-[500px] object-cover" />
